...
function App() {
  const masterTimelineRef = useRef<gsap.core.Timeline | undefined>(undefined);
  ...
  useEffect(() => {
    ...
    let velocityRaf: number | undefined;
      ...
      onUpdate: (self) => {
        ...
        velocityRaf = requestAnimationFrame(() => {
          ...
          document.documentElement.style.setProperty(
            '--scroll-velocity',
            String(Math.abs(currentVelocity)),
          );
        });
      },
    });
  ...
  const animationContextValue: AnimationContextValue = {
    masterTimeline: masterTimelineRef.current,
    registerSection: (name: string, ref: HTMLElement | null) => {
