...
export const SessionManagerHeader = ({
  currentDay,
  sessionStats,
  onCreateClick,
      ...
      <div className={styles.headerContent}>
        <div className={styles.headerLeft}>
          ...
          <div className={styles.badgeGroup}>
            ...
            <div className={styles.badgeRow}>
              <Badge className={cn(styles.statsBadge)} size='lg' radius='sm'>
        ...
        <div className={styles.headerRight}>
          <Button variant='primary' onClick={onCreateClick} className={cn(styles.addButton)}>
            <IconPlus size={16} />
            New Session
          </Button>
        </div>
